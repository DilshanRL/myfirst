...
#cat /home/dilshan/Desktop/ngw/logs/* > /opt/aepona/ngw/gwuser/logs/combined_log


#sort -k1,1 -k2,2 -k3,3 -o "/opt/aepona/ngw/gwuser/logs/sorted_log_file" "/opt/aepona/ngw/gwuser/logs/combined_log"

awk -F " " '{print $1" "$2" "$3"\t"$9" "$10" "$11" "$12" "$13" "$14" "$15}' /opt/aepona/ngw/gwuser/logs/combined_log >test1
...
sed -n "/10:00:00/,/11:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour11
sed -n "/11:00:00/,/12:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour12
sed -n "/12:00:00/,/13:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour13
sed -n "/13:00:00/,/14:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour14
sed -n "/14:00:00/,/15:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour15
sed -n "/15:00:00/,/16:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour16
sed -n "/16:00:00/,/17:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour17
sed -n "/17:00:00/,/18:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour18
sed -n "/18:00:00/,/19:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour19
sed -n "/19:00:00/,/20:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour20
sed -n "/20:00:00/,/21:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour21
sed -n "/21:00:00/,/22:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour22
sed -n "/22:00:00/,/23:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour23
sed -n "/23:00:00/,/00:00:00/p" "$file" >/opt/aepona/ngw/gwuser/hours/hour24




sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour1
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour2
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour3
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour4
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour5
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour6
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour7
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour8
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour9
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour10
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour11
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour12
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour13
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour14
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour15
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour16
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour17
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour18
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour19
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour20
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour21
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour22
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour23
sed -i '$ d' /opt/aepona/ngw/gwuser/hours/hour24
...
echo "                      " 
    ...
    #termgraph < /opt/aepona/ngw/gwuser/para/"$word".txt
